...
geom_boundary_edges_node::geom_boundary_edges_node() : ActData_BaseNode()
{
  ...
  REGISTER_PARAMETER(Shape, PID_Convex);
  REGISTER_PARAMETER(Shape, PID_Concave);
  REGISTER_PARAMETER(Shape, PID_Undefined);
}
...
void geom_boundary_edges_node::Init()
{
  ...
  ActParamTool::AsShape( this->Parameter(PID_Convex)    )->SetShape( TopoDS_Shape(), MT_Silent );
  ActParamTool::AsShape( this->Parameter(PID_Concave)   )->SetShape( TopoDS_Shape(), MT_Silent );
  ActParamTool::AsShape( this->Parameter(PID_Undefined) )->SetShape( TopoDS_Shape(), MT_Silent );
}
