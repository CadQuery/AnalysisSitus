...
public:
  ...
  DEFINE_STANDARD_RTTI_INLINE(visu_mesh_N_scalar_data_provider, visu_mesh_data_provider)
...
public:
  ...
  // OCCT RTTI
  DEFINE_STANDARD_RTTI_INLINE(visu_mesh_N_scalar_pipeline, visu_pipeline)
