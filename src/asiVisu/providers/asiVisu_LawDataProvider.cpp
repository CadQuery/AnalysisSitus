...
//! \param N [in] law Node.
visu_law_data_provider::visu_law_data_provider(const Handle(asiAlgo_DesignLaw_node)& N)
: visu_data_provider(),
  m_node(N)
{}
...
Handle(asiAlgo_DesignLaw) visu_law_data_provider::GetLaw() const
{
...
{
  return ActParamStream() << m_node->Parameter(asiAlgo_DesignLaw_node::PID_Degree)
                          << m_node->Parameter(asiAlgo_DesignLaw_node::PID_Knots)
                          << m_node->Parameter(asiAlgo_DesignLaw_node::PID_Mults)
                          << m_node->Parameter(asiAlgo_DesignLaw_node::PID_Poles);
}
