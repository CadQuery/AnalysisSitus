...
#ifndef ottoEngine_BuildOBBFunc_h
#define ottoEngine_BuildOBBFunc_h
...
//! Tree Function for contructing oriented bounding box on mesh.
class ottoEngine_BuildOBBFunc : public ActData_BaseTreeFunction
{
public:

  // OCCT RTTI
  DEFINE_STANDARD_RTTI_INLINE(ottoEngine_BuildOBBFunc, ActData_BaseTreeFunction)

public:

  static Handle(ottoEngine_BuildOBBFunc)
    Instance();
...
private:
  ...
  ottoEngine_BuildOBBFunc() : ActData_BaseTreeFunction() {}
