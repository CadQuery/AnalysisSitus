...
geom_find_same_hosts::geom_find_same_hosts(const TopTools_IndexedMapOfShape& faces) : m_faces(faces)
{}

//! Finds unique host surfaces.
//! \param groups [in] identified groups.
void geom_find_same_hosts::operator()(t_groups& groups) const
{
...
bool geom_find_same_hosts::findSame(const int                   reference,
