...
//! Default constructor.
journal_logger::journal_logger() : ActAPI_ILogger()
{}
...
ActAPI_LogMessageList journal_logger::PopMessageList()
{
...
//! \return true/false.
unsigned int journal_logger::HasErrors()
{
...
void journal_logger::Info(const TCollection_AsciiString&    theMessage,
...
//! \param theTimeStamp [in] application-specific timestamp. Current timestamp
//!                          is used in case of NULL value passed.
void journal_logger::Notice(const TCollection_AsciiString&    theMessage,
                            const ActAPI_LogMessagePriority   thePriority,
                            const ActAPI_LogArguments&        theArguments,
                            const Handle(Standard_Transient)& theTimeStamp)
{
...
//! \param theTimeStamp [in] application-specific timestamp. Current timestamp
//!                          is used in case of NULL value passed.
void journal_logger::Warn(const TCollection_AsciiString&    theMessage,
                          const ActAPI_LogMessagePriority   thePriority,
                          const ActAPI_LogArguments&        theArguments,
                          const Handle(Standard_Transient)& theTimeStamp)
{
...
//! \param theTimeStamp [in] application-specific timestamp. Current timestamp
//!                          is used in case of NULL value passed.
void journal_logger::Error(const TCollection_AsciiString&    theMessage,
                           const ActAPI_LogMessagePriority   thePriority,
                           const ActAPI_LogArguments&        theArguments,
                           const Handle(Standard_Transient)& theTimeStamp)
{
...
void journal_logger::appendMessage(const TCollection_AsciiString&    theMessage,
