...
bool tess_ply::Read(const TCollection_AsciiString&     theFilename,
                    Handle(Mesh)&                      theMesh,
...
bool tess_ply::Write(const Handle(Mesh)&            theMesh,
...
bool tess_ply::_writeNodes(const Handle(Mesh)&            theMesh,
                           const TCollection_AsciiString& theFilename)
{
...
bool tess_ply::_writeElements(const Handle(Mesh)&            theMesh,
                              const int                      theShift,
                              const TCollection_AsciiString& theFilename)
{
  std::ofstream FILE(theFilename.ToCString(), std::ofstream::app);
