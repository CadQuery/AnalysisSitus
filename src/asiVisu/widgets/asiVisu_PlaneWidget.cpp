/*=========================================================================
  ...
  Module:    asiVisu_PlaneWidget.cpp
  Original:  vtkPlaneWidget.cxx
...
asiVisu_PlaneWidget::asiVisu_PlaneWidget() : vtkPolyDataSourceWidget()
{
  ...
  this->EventCallbackCommand->SetCallback(asiVisu_PlaneWidget::ProcessEvents);
...
asiVisu_PlaneWidget::~asiVisu_PlaneWidget()
{
...
void asiVisu_PlaneWidget::UpdateSurfaceNode()
{
  std::cout << "Update surface Node" << std::endl;
  ...
  m_model->OpenCommand();
  {
    ...
    gp_Ax3 ax3( gp_Pnt(center[0], center[1], center[2]),
                gp_Dir(norm[0], norm[1], norm[2]) );
    //
    Handle(Geom_Plane) plane = new Geom_Plane(ax3);

    m_node->SetSurface(plane);
  }
  m_model->CommitCommand();
}

void asiVisu_PlaneWidget::SetEnabled(int enabling)
{
  if ( ! this->Interactor )
  {
...
//------------------------------------------------------------------------------
void asiVisu_PlaneWidget::RegisterPickers()
{
...
void asiVisu_PlaneWidget::ProcessEvents(vtkObject* vtkNotUsed(object),
                                   unsigned long event,
                                   void* clientdata,
                                   void* vtkNotUsed(calldata))
{
  asiVisu_PlaneWidget* self = reinterpret_cast<asiVisu_PlaneWidget *>( clientdata );
...
void asiVisu_PlaneWidget::PrintSelf(ostream& os, vtkIndent indent)
{
...
void asiVisu_PlaneWidget::PositionHandles()
{
  double *o = this->PlaneSource->GetOrigin();
  double *pt1 = this->PlaneSource->GetPoint1();
  double *pt2 = this->PlaneSource->GetPoint2();
...
int asiVisu_PlaneWidget::HighlightHandle(vtkProp *prop)
{
...
void asiVisu_PlaneWidget::HighlightNormal(int highlight)
{
  if ( highlight )
  {
    this->ValidPick = 1;
...
void asiVisu_PlaneWidget::HighlightPlane(int highlight)
{
  if ( highlight )
  {
    this->ValidPick = 1;
...
void asiVisu_PlaneWidget::OnStartPinch()
{
...
void asiVisu_PlaneWidget::OnPinch()
{
  if ( this->State != asiVisu_PlaneWidget::Pinching)
  {
    return;
  }
...
void asiVisu_PlaneWidget::OnEndPinch()
{
  if ( this->State != asiVisu_PlaneWidget::Pinching)
  {
    return;
...
void asiVisu_PlaneWidget::OnLeftButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
  ...
  else
  {
    ...
    if ( path != NULL )
    {
      ...
      {
        this->State = asiVisu_PlaneWidget::Rotating;
        this->HighlightNormal(1);
      }
      else if (this->Interactor->GetControlKey())
      {
        this->State = asiVisu_PlaneWidget::Spinning;
        this->HighlightNormal(1);
      }
      else
      {
...
void asiVisu_PlaneWidget::OnLeftButtonUp()
{
  if ( this->State == asiVisu_PlaneWidget::Outside ||
       this->State == asiVisu_PlaneWidget::Start )
  {
    return;
  }
...
void asiVisu_PlaneWidget::OnMiddleButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
...
void asiVisu_PlaneWidget::OnMiddleButtonUp()
{
  if ( this->State == asiVisu_PlaneWidget::Outside ||
       this->State == asiVisu_PlaneWidget::Start )
  {
...
void asiVisu_PlaneWidget::OnRightButtonUp()
{
  if ( this->State == asiVisu_PlaneWidget::Outside ||
       this->State == asiVisu_PlaneWidget::Start )
  {
...
void asiVisu_PlaneWidget::OnMouseMove()
{
  ...
  // Process the motion
  if ( this->State == asiVisu_PlaneWidget::Moving )
  {
    // Okay to process
    if ( this->CurrentHandle )
    {
  ...
  else if ( this->State == asiVisu_PlaneWidget::Scaling )
  {
    this->Scale(prevPickPoint, pickPoint, X, Y);
  }
  else if ( this->State == asiVisu_PlaneWidget::Pushing )
  {
    this->Push(prevPickPoint, pickPoint);
  }
  else if ( this->State == asiVisu_PlaneWidget::Rotating )
  {
    camera->GetViewPlaneNormal(vpn);
    this->Rotate(X, Y, prevPickPoint, pickPoint, vpn);
  }
  else if ( this->State == asiVisu_PlaneWidget::Spinning )
  {
...
void asiVisu_PlaneWidget::MoveOrigin(double *p1, double *p2)
{
...
void asiVisu_PlaneWidget::MovePoint1(double *p1, double *p2)
{
  //Get the plane definition
  double *o = this->PlaneSource->GetOrigin();
  double *pt1 = this->PlaneSource->GetPoint1();
...
void asiVisu_PlaneWidget::MovePoint2(double *p1, double *p2)
{
  //Get the plane definition
  double *o = this->PlaneSource->GetOrigin();
  double *pt1 = this->PlaneSource->GetPoint1();
...
void asiVisu_PlaneWidget::MovePoint3(double *p1, double *p2)
{
  //Get the plane definition
  double *o = this->PlaneSource->GetOrigin();
  double *pt1 = this->PlaneSource->GetPoint1();
...
void asiVisu_PlaneWidget::Rotate(int X, int Y, double *p1, double *p2, double *vpn)
{
  double *o = this->PlaneSource->GetOrigin();
  double *pt1 = this->PlaneSource->GetPoint1();
  double *pt2 = this->PlaneSource->GetPoint2();
...
void asiVisu_PlaneWidget::Spin(double *p1, double *p2)
{
  // Mouse motion vector in world space
  double v[3];
  v[0] = p2[0] - p1[0];
...
void asiVisu_PlaneWidget::Translate(double *p1, double *p2)
{
...
void asiVisu_PlaneWidget::Scale(double *p1, double *p2, int vtkNotUsed(X), int Y)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
void asiVisu_PlaneWidget::Push(double *p1, double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
void asiVisu_PlaneWidget::CreateDefaultProperties()
{
  // Handle properties
...
void asiVisu_PlaneWidget::PlaceWidget(double bds[6])
{
  int i;
...
void asiVisu_PlaneWidget::SizeHandles()
{
...
void asiVisu_PlaneWidget::SelectRepresentation()
{
  if ( ! this->CurrentRenderer )
  {
    return;
...
void asiVisu_PlaneWidget::SetResolution(int r)
{
  this->PlaneSource->SetXResolution(r);
  this->PlaneSource->SetYResolution(r);
}

int asiVisu_PlaneWidget::GetResolution()
{
...
void asiVisu_PlaneWidget::SetOrigin(double x, double y, double z)
{
  this->PlaneSource->SetOrigin(x,y,z);
  this->PositionHandles();
}

void asiVisu_PlaneWidget::SetOrigin(double x[3])
{
  this->SetOrigin(x[0], x[1], x[2]);
}

double* asiVisu_PlaneWidget::GetOrigin()
{
  return this->PlaneSource->GetOrigin();
}

void asiVisu_PlaneWidget::GetOrigin(double xyz[3])
{
...
void asiVisu_PlaneWidget::SetPoint1(double x, double y, double z)
{
  this->PlaneSource->SetPoint1(x,y,z);
  this->PositionHandles();
}

void asiVisu_PlaneWidget::SetPoint1(double x[3])
{
  this->SetPoint1(x[0], x[1], x[2]);
}

double* asiVisu_PlaneWidget::GetPoint1()
{
  return this->PlaneSource->GetPoint1();
}

void asiVisu_PlaneWidget::GetPoint1(double xyz[3])
{
...
void asiVisu_PlaneWidget::SetPoint2(double x, double y, double z)
{
  this->PlaneSource->SetPoint2(x,y,z);
  this->PositionHandles();
}

void asiVisu_PlaneWidget::SetPoint2(double x[3])
{
  this->SetPoint2(x[0], x[1], x[2]);
}

double* asiVisu_PlaneWidget::GetPoint2()
{
  return this->PlaneSource->GetPoint2();
}

void asiVisu_PlaneWidget::GetPoint2(double xyz[3])
{
...
void asiVisu_PlaneWidget::SetCenter(double x, double y, double z)
{
...
// Description:
// Set the center of the plane.
void asiVisu_PlaneWidget::SetCenter(double c[3])
{
...
double* asiVisu_PlaneWidget::GetCenter()
{
  return this->PlaneSource->GetCenter();
}

void asiVisu_PlaneWidget::GetCenter(double xyz[3])
{
...
void asiVisu_PlaneWidget::SetNormal(double x, double y, double z)
{
...
// Description:
// Set the normal to the plane.
void asiVisu_PlaneWidget::SetNormal(double n[3])
{
...
double* asiVisu_PlaneWidget::GetNormal()
{
  return this->PlaneSource->GetNormal();
}

void asiVisu_PlaneWidget::GetNormal(double xyz[3])
{
  this->PlaneSource->GetNormal(xyz);
}

void asiVisu_PlaneWidget::GetPolyData(vtkPolyData *pd)
{
  pd->ShallowCopy(this->PlaneSource->GetOutput());
}

vtkPolyDataAlgorithm *asiVisu_PlaneWidget::GetPolyDataAlgorithm()
{
...
void asiVisu_PlaneWidget::UpdatePlacement(void)
{
  this->PlaneSource->Update();
  this->PositionHandles();
}
