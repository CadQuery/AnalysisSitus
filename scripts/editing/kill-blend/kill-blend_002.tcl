...
set datafile     cad/blends/0008_boxblend_02.brep
set ref_ncomp    1
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
#
init-naming
kev -edge edge_2 -vertex vertex_3
kev -edge edge_10 -vertex vertex_8
kef -face face_3 -kedge edge_9 -sedge edge_7
kev -edge edge_16 -vertex vertex_10
kef -face face_8 -kedge edge_14 -sedge edge_17
#
if { [check-euler 0] != 1 } {
