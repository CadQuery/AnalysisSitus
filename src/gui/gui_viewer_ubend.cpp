...
gui_viewer_ubend::gui_viewer_ubend(QWidget* parent) : gui_viewer(parent)
{
  // Initialize Presentation Manager along with QVTK widget
  common_facilities::Instance()->Prs.UBend = vtkSmartPointer<visu_prs_manager>::New();
  m_prs_mgr = common_facilities::Instance()->Prs.UBend;
  //
...
//! Destructor.
gui_viewer_ubend::~gui_viewer_ubend()
{
}

//! Updates viewer.
void gui_viewer_ubend::Repaint()
{
  m_prs_mgr->GetQVTKWidget()->repaint();
}

//! Resets view.
void gui_viewer_ubend::onResetView()
{
