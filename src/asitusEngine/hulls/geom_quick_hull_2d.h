...
#ifndef geom_quick_hull_2d_h
#define geom_quick_hull_2d_h
...
public:
  ...
  geom_quick_hull_2d(const Handle(geom_common_point_cloud_2d)& cloud);
...
public:
  ...
  inline const Handle(geom_common_point_cloud_2d)& Cloud() const
  {
    return m_cloud;
  }
  ...
  inline const Handle(TColStd_HSequenceOfInteger)& Hull() const
  {
    return m_hull;
  }
...
private:
  ...
  Handle(geom_common_point_cloud_2d) m_cloud; //!< Initial cloud.
