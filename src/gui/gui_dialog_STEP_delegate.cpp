...
//! Constructor.
gui_dialog_STEP_delegate::gui_dialog_STEP_delegate(QObject* parent)
...
void gui_dialog_STEP_delegate::setEditorData(QWidget*           editor,
                                             const QModelIndex& index) const
{
  if ( !index.column() )
    return;
...
void gui_dialog_STEP_delegate::setModelData(QWidget*            editor,
