...
geom_quick_hull_2d::geom_quick_hull_2d(const Handle(geom_common_point_cloud_2d)& cloud)
{
  m_cloud = cloud;
...
geom_quick_hull_2d::~geom_quick_hull_2d()
{
...
bool geom_quick_hull_2d::Perform()
{
...
int geom_quick_hull_2d::findDistantPoint(const int  p1_idx,
                                         const int  p2_idx,
                                         const bool up) const
{
...
void geom_quick_hull_2d::process(PNode*     prev,
                                 PNode*     curr,
                                 const bool left,
                                 const bool up)
{
...
void geom_quick_hull_2d::traverseTriplet(PNode*     parent,
                                         const bool ccw)
{
...
void geom_quick_hull_2d::releaseNode(PNode* node)
{
  if ( node && node->left )
...
void geom_quick_hull_2d::addNode(PNode* node)
{
  if ( node->idx == -1 )
    return;
